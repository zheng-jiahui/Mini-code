...
def build_default_registry(include: Optional[list] = None) -> ToolRegistry:
    ...
    """
    from . import filesystem, meta, patch, repair, review, search, shell, todo, extra, git_tool, memory, fsops, recall

    registry = ToolRegistry()
    modules = [filesystem, search, shell, meta, repair, review, patch, todo, extra, git_tool, memory, fsops, recall]
    for mod in modules:
